...
// Кожен об’єкт описує день тижня та The number of calories calories, спожитих спортсменом, у цей день.
// Візьми код нижче і встав після оголошення своєї функції для перевірки коректності її роботи.У консоль будуть виведені результати її викликів.

const calcAverageCalories = days => {
  let weeklyAverageCaloriesOfWeek = 0;
  for (const day of days) {
    weeklyAverageCaloriesOfWeek += day.calories / days.length;
  }
